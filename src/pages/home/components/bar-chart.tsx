...
export default function BarChart() {
	...
	const tooltipTitle = (
		<>
			...
			<div>
				-
				{t("home.systemStabilityExplanation")}
			</div>
			<div>
				-
				{t("home.deploymentFrequencyExplanation")}
			</div>
			<div>
				-
				{t("home.leadTimeExplanation")}
			</div>
			<div>
				-
				{t("home.mttrExplanation")}
			</div>
			<div>
				-
				{t("home.changeFailureRateExplanation")}
			</div>
		</>
	);
